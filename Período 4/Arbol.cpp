...
//Manera 1 de mostrar el arbol(dibujado)
...
int main(){
	...
	//Manera 1 de mostra el arbol binario
	
	cout << "\t      Mostrando Arbol Binario\n\n";
	...
	cout << "\t   |         |       |         |\n";
	cout << "\t   " << arbol.get_root()->left->left->key_value <<"         " << arbol.get_root()->left->right->key_value << "      " << arbol.get_root()->right->left->key_value << "         " << arbol.get_root()->right->right->key_value << "\n";
	cout << "       ____|____\n";
	cout << "      |         |\n";
	cout << "      " << arbol.get_root()->left->left->left->key_value << "         " << arbol.get_root()->left->left->right->key_value << "\n\n\n"; 
