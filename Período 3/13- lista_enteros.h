...
//Nombre del programa: lista_enteros.h
...
ListaEnteros::~ListaEnteros()
{
	...
	{
		this->remover(0);			// remover la cabeza de la lista hasta que cuenta sea 0 o sea esté vacía
	}
}
...
void ListaEnteros::insertar(int indice, int item)
{
	...
	} else { 			// sino, identificar el nodo previo y actualizar los enlaces
